            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="district-form-content add-new-district-form">
                        <form class="district-fields" method="POST" action='<?php echo e(url("/admin/users/{$user->id}")); ?>'>
                                ...
                                <div class="form-group custom-select">
                                    <label>Type:</label>
                                    <select class="<?php echo e($errors->has('type') ? ' is-invalid' : ''); ?> district-input-field form-control usertype select2" name="type" onchange="TypeOnChange(this.value)"  required>
                                        <option value="">-- Select Type --</option>
                                        <option value="admin" <?php echo e($user->type == 'admin' ? 'selected' : ''); ?>>Admin</option>
                                        <option value="member" <?php echo e($user->type == 'member' ? 'selected' : ''); ?>>Member</option>
                                        <option value="vendor" <?php echo e($user->type == 'vendor' ? 'selected' : ''); ?>>Vendor</option>
                                    </select>
                                ...
                                <div class="form-group <?php echo e($user->type == 'member' ? '' : 'hidden'); ?> select_apartment_area custom-select">
                                    <label>Select Apartment:</label>
                                    <select class="<?php echo e($errors->has('type') ? ' is-invalid' : ''); ?> district-input-field form-control select_apartment select2"   name="apartment_id" >
                                        ...
                                        <option value="<?php echo e($apartment->id); ?>" <?php echo e(old('apartment_id',$user->apartment_id) == $apartment->id ? 'selected="selected"' : ''); ?> ><?php echo e($apartment->apartment_id); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>                                    
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <input type="text" id="username" title="Username!" name="username" class="district-input-field form-control" placeholder="Username" value="<?php echo e(old('username',$user->username)); ?>" >
                                    <div id="msg_3">&nbsp;</div>
                                </div>
                                <div class="form-group">
                                    <label>Email :</label>
                                    <input type="text" id="email" title="Email!" name="email" class="district-input-field form-control" placeholder="Email" value="<?php echo e(old('email',$user->email)); ?>" required>
                                    <div id="msg_2">&nbsp;</div>
                                </div>
                                <div class="form-group">
                                    <label>Phone :</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile_number" id="mobile_number" title="enter Mobile Number!" class="<?php echo e($errors->has('mobile_number') ? ' is-invalid' : ''); ?> district-input-field form-control" placeholder="Mobile Number"
                                           value="<?php echo e(old('mobile_number',$user->mobile_number)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gender" id="gender" title="Select Gender!" class="<?php echo e($errors->has('gender') ? ' is-invalid' : ''); ?> district-input-field form-control">
                                        <option <?php echo e(old('gender',$user->gender) == 'male' ? 'selected="selected"' : ''); ?> value="male">Male</option>
                                        <option <?php echo e(old('gender',$user->gender) == 'female' ? 'selected="selected"' : ''); ?> value="female">Female</option>
                                    </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\rosen\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>