      ...
      <div class="row pb-md-5 justify-content-center">       
        ...
        <div class="col-md-12">         
          ...
          <div class="loundry-bookingtab table-responsive">
                      ...
                      <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <span class="badge badge-info"><?php echo e($record->issue_status); ?></span>
              ...
              <?php else: ?>
                <h3 class="mt-5"><?php echo e(__('No record found')); ?></h3> 
              <?php endif; ?> 
          </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\rosen\resources\views/report_issues/vendor/history.blade.php ENDPATH**/ ?>