        ...
        <div class="right-section-content">
            <div class="admin-sec-btn-area">
                ...
                <div class="database-btn">
                    <a href="<?php echo e(url('admin/issue_reasons/create')); ?>" data-toggle="" data-target="#search-db-model"  class="BE-btn">Add</a>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($record->id); ?>">
                                ...
                                <td >
                                    ...
                                    <span class="label label-success"><?php echo e(__("Active")); ?></span>
                                    <?php else: ?>
                                    <span class="label label-danger"><?php echo e(__("InActive")); ?></span>
                                    <?php endif; ?>
                                   
                                </td>
                                <td>
                                    <a href="<?php echo e(url('admin/issue_reasons/')); ?>/<?php echo e($record->id); ?>/edit/" class="text-success" title="Edit Record"><i class="fa fa-pencil"></i></a>
                                </td>
                            </tr>
            ...
            datatable.on('row-reorder', function (e, details) {
                if(details.length) {
                    ...
                    $.ajax({
                        ...
                        method: 'POST',
                        url: "<?php echo e(url('admin/issue_reasons/update_position')); ?>",
                        data: { rows }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\rosen\resources\views/admin/report_issue_reasons/index.blade.php ENDPATH**/ ?>