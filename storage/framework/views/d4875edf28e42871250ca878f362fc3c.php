...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <meta name="home_url" content="<?php echo e(url('')); ?>">
    ...
    <link rel="shortcut icon" href="<?php echo url('public/assets/images/logo-npc.png'); ?>" />    
    ...
    <!-- <link href="<?php echo url('public/assets/css/jquery-ui.css'); ?>" rel="stylesheet"> -->
    ...
    <script src="<?php echo url('public/assets/js/dataTables/datatables.min.js'); ?>"></script>
    ...
    <?php echo $__env->make('layouts.includes.global-style', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->yieldContent('app-script'); ?>
<?php /**PATH E:\wamp64\www\cmax1\resources\views/layouts/app.blade.php ENDPATH**/ ?>