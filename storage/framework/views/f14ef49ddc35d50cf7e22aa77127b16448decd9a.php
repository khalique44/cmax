        ...
        <div class="right-section-content">
            <div class="admin-sec-btn-area">
                ...
                <div class="database-btn">
                    <a href="<?php echo e(url('admin/home_page/testimonials/create')); ?>" data-toggle="" data-target="#search-db-model"  class="BE-btn">Add</a>
                </div>
            </div>
                    ...
                    <table id="table_main" class="display" style="width:100%">
                        ...
                        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($record->id); ?>">
                                ...
                                <td><?php echo e($record->client_name); ?></td>
                                <td>
                                     <?php if(!empty($record->file_url)): ?>
                                    <a href="<?php echo url('public'); ?>/<?php echo e($record->file_url); ?>" target="_blank">
                                         
                                        <img src="<?php echo url('public'); ?>/<?php echo e($record->file_url); ?>" class="logo" alt="Logo" width="50%">
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(url('admin/home_page/testimonials/')); ?>/<?php echo e($record->id); ?>/edit/" class="text-success" title="Edit Record"><i class="fa fa-pencil"></i></a>
                ...
                datatable.on('row-reorder', function (e, details) {
                    if(details.length) {
                        ...
                        $.ajax({
                            ...
                            method: 'POST',
                            url: "<?php echo e(url('admin/home_page/testimonials/update_position')); ?>",
                            data: { rows }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\rosen\resources\views/admin/home_page/testimonials/index.blade.php ENDPATH**/ ?>